...
class ATM:
    ...
    ##### Add a new method print_transactions() to your class for printing out the list of transactions fro part 2
    def print_transactions(): ##### Currently does nothing.
        return

ledger = [] # Initialize ledger to maintain a list of transactions for Part 2
...
while True:
    ...
    if command == 'balance':
        ...
        print(*ledger, sep = '\n') # Display ledger list as values seperated by new lines.
    elif command == 'help':
