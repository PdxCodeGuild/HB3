...
hundreds_place = {111:'One Hundred - Eleven', 100:"One - Hundred", 200:"Two - Hundred", 300:"Three - Hundred", 400:"Four - Hundred", 500:"Five - Hundred", 
...
elif int(number[1]) == 1 and int(number[2]) == 1:
    ones_digit = int(number[0])
    print (f"Your number is: {numbers[ones_digit]} hundred - eleven")
elif int(number[2]) == 0:
    ones_digit =  int(number[0])
    tens_digit =  int(number[1])
