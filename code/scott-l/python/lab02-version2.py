...
# Create a English Dictionaries index for each of the digits between 0-999
english_ones_digit = {
    0: 'zero', 
    1 : 'one',
    2 : 'two',
...
hundreds_digit = user_input_num//100
# print(f'Hundreds digit', {hundreds_digit})  # DEBUG PRINT
...
# if hundreds digit is greater than zero
if hundreds_digit > 0:
    # If the tens digit is zero 
    if tens_digit == 0:
        # if the ones digit is zero then print hundreds
        if ones_digit == 0:
            print(english_hundreds_digit[hundreds_digit] + ' hundred')  # Condition for 0
        # else if the ones digit is 1-9 then print hundreds plus ones digit
        else:
            print(english_hundreds_digit[hundreds_digit] + ' hundred and ' + english_ones_digit[ones_digit])  # Condition for 0-9
        # end if
    # If the ten digit is 1 and ones digit is zero then use english_teens_digit with zero ones digit index
        ...
        print(english_hundreds_digit[hundreds_digit] + ' hundred and' + english_teens_digit[ones_digit])  # Uniqe condition for ten
    # if the ten digit is 1 and ones digits is 1-9 use the english_teens_digit
    elif tens_digit == 1:
        print(english_hundreds_digit[hundreds_digit] + ' hundred and ' + english_teens_digit[ones_digit])  # conditions for 11-19
    # if the ten digit is 2-9 then check the ones_digit
    elif tens_digit > 1:
        # if the ones digit is 0 then use english_tens_digit 
        if ones_digit == 0:
            print(english_hundreds_digit[hundreds_digit] + ' hundred and ' + english_tens_digit[tens_digit]) 
         # Else if the ones digit is > than zero 
        else: 
            print(english_hundreds_digit[hundreds_digit] + ' hundred and ' + english_tens_digit[tens_digit] +'-'+ english_ones_digit[ones_digit]) # conditions for 20-99
    #     # end if     
    #end if
# if hundreds is zero then print numbers 0-99
else:
